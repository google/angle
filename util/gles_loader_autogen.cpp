...
ANGLE_UTIL_EXPORT PFNGLTRIMMEMORYANGLEPROC l_glTrimMemoryANGLE;
...
void LoadUtilGLES(LoadProc loadProc)
{
    ...
    l_glTrimMemoryANGLE = reinterpret_cast<PFNGLTRIMMEMORYANGLEPROC>(loadProc("glTrimMemoryANGLE"));
