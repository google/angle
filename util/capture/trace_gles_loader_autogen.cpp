...
ANGLE_TRACE_LOADER_EXPORT PFNGLTRIMMEMORYANGLEPROC t_glTrimMemoryANGLE;
...
void LoadTraceGLES(LoadProc loadProc)
{
    ...
    t_glTrimMemoryANGLE = reinterpret_cast<PFNGLTRIMMEMORYANGLEPROC>(loadProc("glTrimMemoryANGLE"));
