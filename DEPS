...
vars = {
  ...
  'chromium_revision': 'efbcef254191462cc27730a3b9f21beb5030d255',
  # We never want to checkout chromium,
  # but need a dummy DEPS entry for the autoroller
  'dummy_checkout_chromium': False,

  # Current revision of VK-GL-CTS (a.k.a dEQP).
  'vk_gl_cts_revision': '618e41c871d66e513224327c78aac3522d35a4a7',

  # Current revision of glslang, the Khronos SPIRV compiler.
  'glslang_revision': '2067d1a93e6edc17f2a6b7e3e5138a9bbcd35ef9',
  ...
  'spirv_tools_revision': 'c2553a315f5c78d73a808526782596d4e3870082',

  # Current revision of Khronos Vulkan-Headers.
  'vulkan_headers_revision': '94ff600cc8623a2fd270cc14b14def3fca12ffaf',

  # Current revision of Khronos Vulkan-Loader.
  'vulkan_loader_revision': '14ad927e679a0239516121ced288041f00bbaa26',

  # Current revision of Khronos Vulkan-Tools.
  'vulkan_tools_revision': '1abaced34b84831f60226ce67a702b2d841e1d87',

  # Current revision of Khronos Vulkan-ValidationLayers.
  'vulkan_validation_revision': '0046c31f2f96e986735602fa68069f10b2e932c4',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@8dae5d8e04e901d4e810fc7a7627973c2832bfcd',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@b4cc6eb191edf053c625f923c359f77760c63028',
    'condition': 'not build_with_chromium',
  },
  ...
  'third_party/SwiftShader': {
    'url': '{swiftshader_git}/SwiftShader@51b03d58fb17b09120c886d5df36fb191d12fa8e',
    'condition': 'not build_with_chromium',
  },
  ...
  'tools/mb': {
    'url': '{chromium_git}/chromium/src/tools/mb@d3154dd7d9a330d57057f381d3139d76695a35c3',
    'condition': 'not build_with_chromium',
  },
