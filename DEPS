...
vars = {
  ...
  'glslang_revision': '55f9d97f3b1e2b9d0a5f015a3075512f698e1efa',
  ...
  'vulkan_validation_revision': 'fe0b6a61d73275acfd4d89abee82c3553c119f7d',
...
deps = {
  ...
  'third_party/SwiftShader': {
    'url': '{swiftshader_git}/SwiftShader@d9ba4b7dd30b2a5d824d7230d176c0ff99c2e5a2',
    'condition': 'not build_with_chromium',
  },
