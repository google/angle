...
class BuiltInId
{
  public:
    ...
    static constexpr const TSymbolUniqueId gl_ClipDistance          = TSymbolUniqueId(2295);
    static constexpr const TSymbolUniqueId gl_InstanceID            = TSymbolUniqueId(2296);
    static constexpr const TSymbolUniqueId gl_InstanceIndex         = TSymbolUniqueId(2297);
    static constexpr const TSymbolUniqueId gl_VertexID              = TSymbolUniqueId(2298);
    static constexpr const TSymbolUniqueId gl_VertexIndex           = TSymbolUniqueId(2299);
    static constexpr const TSymbolUniqueId gl_ViewportIndex         = TSymbolUniqueId(2300);
    static constexpr const TSymbolUniqueId gl_LayerVS               = TSymbolUniqueId(2301);
    static constexpr const TSymbolUniqueId gl_DrawID                = TSymbolUniqueId(2302);
    static constexpr const TSymbolUniqueId gl_BaseVertex            = TSymbolUniqueId(2303);
    static constexpr const TSymbolUniqueId gl_BaseInstance          = TSymbolUniqueId(2304);
    static constexpr const TSymbolUniqueId angle_BaseVertex         = TSymbolUniqueId(2305);
    static constexpr const TSymbolUniqueId angle_BaseInstance       = TSymbolUniqueId(2306);
    static constexpr const TSymbolUniqueId gl_NumWorkGroups         = TSymbolUniqueId(2307);
    static constexpr const TSymbolUniqueId gl_WorkGroupSize         = TSymbolUniqueId(2308);
    static constexpr const TSymbolUniqueId gl_WorkGroupID           = TSymbolUniqueId(2309);
    static constexpr const TSymbolUniqueId gl_LocalInvocationID     = TSymbolUniqueId(2310);
    static constexpr const TSymbolUniqueId gl_GlobalInvocationID    = TSymbolUniqueId(2311);
    static constexpr const TSymbolUniqueId gl_LocalInvocationIndex  = TSymbolUniqueId(2312);
    static constexpr const TSymbolUniqueId gl_PrimitiveIDIn         = TSymbolUniqueId(2313);
    static constexpr const TSymbolUniqueId gl_InvocationID          = TSymbolUniqueId(2314);
    static constexpr const TSymbolUniqueId gl_PrimitiveIDGS         = TSymbolUniqueId(2315);
    static constexpr const TSymbolUniqueId gl_LayerGS               = TSymbolUniqueId(2316);
    static constexpr const TSymbolUniqueId gl_PerVertex             = TSymbolUniqueId(2317);
    static constexpr const TSymbolUniqueId gl_in                    = TSymbolUniqueId(2318);
    static constexpr const TSymbolUniqueId gl_PerVertexOutBlock     = TSymbolUniqueId(2319);
    static constexpr const TSymbolUniqueId gl_PositionGS            = TSymbolUniqueId(2320);
    static constexpr const TSymbolUniqueId gl_ViewID_OVR            = TSymbolUniqueId(2321);
