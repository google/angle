...
class BuiltInId
{
  public:
    ...
    static constexpr const TSymbolUniqueId gl_PatchVerticesInTES        = TSymbolUniqueId(3045);
    static constexpr const TSymbolUniqueId gl_PatchVerticesInTESES3_2   = TSymbolUniqueId(3046);
    static constexpr const TSymbolUniqueId gl_PrimitiveIDTES            = TSymbolUniqueId(3047);
    static constexpr const TSymbolUniqueId gl_PrimitiveIDTESES3_2       = TSymbolUniqueId(3048);
    static constexpr const TSymbolUniqueId gl_TessCoord                 = TSymbolUniqueId(3049);
    static constexpr const TSymbolUniqueId gl_TessLevelOuterTES         = TSymbolUniqueId(3050);
    static constexpr const TSymbolUniqueId gl_TessLevelOuterTESES3_2    = TSymbolUniqueId(3051);
    static constexpr const TSymbolUniqueId gl_TessLevelInnerTES         = TSymbolUniqueId(3052);
    static constexpr const TSymbolUniqueId gl_TessLevelInnerTESES3_2    = TSymbolUniqueId(3053);
    static constexpr const TSymbolUniqueId gl_PerVertexTES              = TSymbolUniqueId(3054);
    static constexpr const TSymbolUniqueId gl_PerVertexTESES3_2         = TSymbolUniqueId(3055);
    static constexpr const TSymbolUniqueId gl_inTES                     = TSymbolUniqueId(3056);
    static constexpr const TSymbolUniqueId gl_inTESES3_2                = TSymbolUniqueId(3057);
    static constexpr const TSymbolUniqueId gl_outTES                    = TSymbolUniqueId(3058);
    static constexpr const TSymbolUniqueId gl_outTESES3_2               = TSymbolUniqueId(3059);
    static constexpr const TSymbolUniqueId gl_PerVertexOutTesBlock      = TSymbolUniqueId(3060);
    static constexpr const TSymbolUniqueId gl_PerVertexOutTesBlockES3_2 = TSymbolUniqueId(3061);
    static constexpr const TSymbolUniqueId gl_PositionTES               = TSymbolUniqueId(3062);
    static constexpr const TSymbolUniqueId gl_PositionTESES3_2          = TSymbolUniqueId(3063);
    static constexpr const TSymbolUniqueId gl_ViewID_OVR                = TSymbolUniqueId(3064);
