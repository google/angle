...
class BuiltInId
{
  public:
    ...
    static constexpr const TSymbolUniqueId gl_MaxVertexAttribs             = TSymbolUniqueId(2255);
    static constexpr const TSymbolUniqueId gl_MaxVertexUniformVectors      = TSymbolUniqueId(2256);
    static constexpr const TSymbolUniqueId gl_MaxVertexTextureImageUnits   = TSymbolUniqueId(2257);
    static constexpr const TSymbolUniqueId gl_MaxCombinedTextureImageUnits = TSymbolUniqueId(2258);
    static constexpr const TSymbolUniqueId gl_MaxTextureImageUnits         = TSymbolUniqueId(2259);
    static constexpr const TSymbolUniqueId gl_MaxFragmentUniformVectors    = TSymbolUniqueId(2260);
    static constexpr const TSymbolUniqueId gl_MaxVaryingVectors            = TSymbolUniqueId(2261);
    static constexpr const TSymbolUniqueId gl_MaxDrawBuffers               = TSymbolUniqueId(2262);
    static constexpr const TSymbolUniqueId gl_MaxDualSourceDrawBuffersEXT  = TSymbolUniqueId(2263);
    static constexpr const TSymbolUniqueId gl_MaxVertexOutputVectors       = TSymbolUniqueId(2264);
    static constexpr const TSymbolUniqueId gl_MaxFragmentInputVectors      = TSymbolUniqueId(2265);
    static constexpr const TSymbolUniqueId gl_MinProgramTexelOffset        = TSymbolUniqueId(2266);
    static constexpr const TSymbolUniqueId gl_MaxProgramTexelOffset        = TSymbolUniqueId(2267);
    static constexpr const TSymbolUniqueId gl_MaxImageUnits                = TSymbolUniqueId(2268);
    static constexpr const TSymbolUniqueId gl_MaxVertexImageUniforms       = TSymbolUniqueId(2269);
    static constexpr const TSymbolUniqueId gl_MaxFragmentImageUniforms     = TSymbolUniqueId(2270);
    static constexpr const TSymbolUniqueId gl_MaxComputeImageUniforms      = TSymbolUniqueId(2271);
    static constexpr const TSymbolUniqueId gl_MaxCombinedImageUniforms     = TSymbolUniqueId(2272);
    static constexpr const TSymbolUniqueId gl_MaxCombinedShaderOutputResources =
        TSymbolUniqueId(2273);
    static constexpr const TSymbolUniqueId gl_MaxComputeWorkGroupCount    = TSymbolUniqueId(2274);
    static constexpr const TSymbolUniqueId gl_MaxComputeWorkGroupSize     = TSymbolUniqueId(2275);
    static constexpr const TSymbolUniqueId gl_MaxComputeUniformComponents = TSymbolUniqueId(2276);
    static constexpr const TSymbolUniqueId gl_MaxComputeTextureImageUnits = TSymbolUniqueId(2277);
    static constexpr const TSymbolUniqueId gl_MaxComputeAtomicCounters    = TSymbolUniqueId(2278);
    static constexpr const TSymbolUniqueId gl_MaxComputeAtomicCounterBuffers =
        TSymbolUniqueId(2279);
    static constexpr const TSymbolUniqueId gl_MaxVertexAtomicCounters       = TSymbolUniqueId(2280);
    static constexpr const TSymbolUniqueId gl_MaxFragmentAtomicCounters     = TSymbolUniqueId(2281);
    static constexpr const TSymbolUniqueId gl_MaxCombinedAtomicCounters     = TSymbolUniqueId(2282);
    static constexpr const TSymbolUniqueId gl_MaxAtomicCounterBindings      = TSymbolUniqueId(2283);
    static constexpr const TSymbolUniqueId gl_MaxVertexAtomicCounterBuffers = TSymbolUniqueId(2284);
    ...
    static constexpr const TSymbolUniqueId gl_MaxAtomicCounterBufferSize   = TSymbolUniqueId(2287);
    static constexpr const TSymbolUniqueId gl_MaxGeometryInputComponents   = TSymbolUniqueId(2288);
    static constexpr const TSymbolUniqueId gl_MaxGeometryOutputComponents  = TSymbolUniqueId(2289);
    static constexpr const TSymbolUniqueId gl_MaxGeometryImageUniforms     = TSymbolUniqueId(2290);
    static constexpr const TSymbolUniqueId gl_MaxGeometryTextureImageUnits = TSymbolUniqueId(2291);
    static constexpr const TSymbolUniqueId gl_MaxGeometryOutputVertices    = TSymbolUniqueId(2292);
    static constexpr const TSymbolUniqueId gl_MaxGeometryTotalOutputComponents =
        TSymbolUniqueId(2293);
    static constexpr const TSymbolUniqueId gl_MaxGeometryUniformComponents = TSymbolUniqueId(2294);
    static constexpr const TSymbolUniqueId gl_MaxGeometryAtomicCounters    = TSymbolUniqueId(2295);
    static constexpr const TSymbolUniqueId gl_MaxGeometryAtomicCounterBuffers =
        TSymbolUniqueId(2296);
    static constexpr const TSymbolUniqueId gl_FragCoord             = TSymbolUniqueId(2297);
    static constexpr const TSymbolUniqueId gl_FrontFacing           = TSymbolUniqueId(2298);
    static constexpr const TSymbolUniqueId gl_PointCoord            = TSymbolUniqueId(2299);
    static constexpr const TSymbolUniqueId gl_FragColor             = TSymbolUniqueId(2300);
    static constexpr const TSymbolUniqueId gl_FragData              = TSymbolUniqueId(2301);
    static constexpr const TSymbolUniqueId gl_FragDepth             = TSymbolUniqueId(2302);
    static constexpr const TSymbolUniqueId gl_HelperInvocation      = TSymbolUniqueId(2303);
    static constexpr const TSymbolUniqueId gl_SecondaryFragColorEXT = TSymbolUniqueId(2304);
    static constexpr const TSymbolUniqueId gl_SecondaryFragDataEXT  = TSymbolUniqueId(2305);
    static constexpr const TSymbolUniqueId gl_FragDepthEXT          = TSymbolUniqueId(2306);
    static constexpr const TSymbolUniqueId gl_LastFragData          = TSymbolUniqueId(2307);
    static constexpr const TSymbolUniqueId gl_LastFragColor         = TSymbolUniqueId(2308);
    static constexpr const TSymbolUniqueId gl_LastFragDataNV        = TSymbolUniqueId(2309);
    static constexpr const TSymbolUniqueId gl_LastFragColorARM      = TSymbolUniqueId(2310);
    static constexpr const TSymbolUniqueId gl_PrimitiveID           = TSymbolUniqueId(2311);
    static constexpr const TSymbolUniqueId gl_Layer                 = TSymbolUniqueId(2312);
    static constexpr const TSymbolUniqueId gl_Position              = TSymbolUniqueId(2313);
    static constexpr const TSymbolUniqueId gl_PointSize             = TSymbolUniqueId(2314);
    static constexpr const TSymbolUniqueId gl_InstanceID            = TSymbolUniqueId(2315);
    static constexpr const TSymbolUniqueId gl_InstanceIndex         = TSymbolUniqueId(2316);
    static constexpr const TSymbolUniqueId gl_VertexID              = TSymbolUniqueId(2317);
    static constexpr const TSymbolUniqueId gl_VertexIndex           = TSymbolUniqueId(2318);
    static constexpr const TSymbolUniqueId gl_ViewportIndex         = TSymbolUniqueId(2319);
    static constexpr const TSymbolUniqueId gl_LayerVS               = TSymbolUniqueId(2320);
    static constexpr const TSymbolUniqueId gl_DrawID                = TSymbolUniqueId(2321);
    static constexpr const TSymbolUniqueId gl_BaseVertex            = TSymbolUniqueId(2322);
    static constexpr const TSymbolUniqueId gl_BaseInstance          = TSymbolUniqueId(2323);
    static constexpr const TSymbolUniqueId angle_BaseVertex         = TSymbolUniqueId(2324);
    static constexpr const TSymbolUniqueId angle_BaseInstance       = TSymbolUniqueId(2325);
    static constexpr const TSymbolUniqueId gl_ClipDistance          = TSymbolUniqueId(2326);
    static constexpr const TSymbolUniqueId gl_MaxClipDistances      = TSymbolUniqueId(2327);
    static constexpr const TSymbolUniqueId gl_NumWorkGroups         = TSymbolUniqueId(2328);
    static constexpr const TSymbolUniqueId gl_WorkGroupSize         = TSymbolUniqueId(2329);
    static constexpr const TSymbolUniqueId gl_WorkGroupID           = TSymbolUniqueId(2330);
    static constexpr const TSymbolUniqueId gl_LocalInvocationID     = TSymbolUniqueId(2331);
    static constexpr const TSymbolUniqueId gl_GlobalInvocationID    = TSymbolUniqueId(2332);
    static constexpr const TSymbolUniqueId gl_LocalInvocationIndex  = TSymbolUniqueId(2333);
    static constexpr const TSymbolUniqueId gl_PrimitiveIDIn         = TSymbolUniqueId(2334);
    static constexpr const TSymbolUniqueId gl_InvocationID          = TSymbolUniqueId(2335);
    static constexpr const TSymbolUniqueId gl_PrimitiveIDGS         = TSymbolUniqueId(2336);
    static constexpr const TSymbolUniqueId gl_LayerGS               = TSymbolUniqueId(2337);
    static constexpr const TSymbolUniqueId gl_PerVertex             = TSymbolUniqueId(2338);
    static constexpr const TSymbolUniqueId gl_in                    = TSymbolUniqueId(2339);
    static constexpr const TSymbolUniqueId gl_PerVertexOutBlock     = TSymbolUniqueId(2340);
    static constexpr const TSymbolUniqueId gl_PositionGS            = TSymbolUniqueId(2341);
    static constexpr const TSymbolUniqueId gl_ViewID_OVR            = TSymbolUniqueId(2342);
