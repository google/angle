...
class BuiltInId
{
  public:
    ...
    static constexpr const TSymbolUniqueId gl_PerVertexOutTcsBlock      = TSymbolUniqueId(3042);
    static constexpr const TSymbolUniqueId gl_PerVertexOutTcsBlockES3_2 = TSymbolUniqueId(3043);
    static constexpr const TSymbolUniqueId gl_PositionTCS               = TSymbolUniqueId(3044);
    static constexpr const TSymbolUniqueId gl_PositionTCSES3_2          = TSymbolUniqueId(3045);
    static constexpr const TSymbolUniqueId gl_BoundingBoxEXTTCS         = TSymbolUniqueId(3046);
    static constexpr const TSymbolUniqueId gl_BoundingBoxEXTTCSES3_2    = TSymbolUniqueId(3047);
    static constexpr const TSymbolUniqueId gl_PatchVerticesInTES        = TSymbolUniqueId(3048);
    static constexpr const TSymbolUniqueId gl_PatchVerticesInTESES3_2   = TSymbolUniqueId(3049);
    static constexpr const TSymbolUniqueId gl_PrimitiveIDTES            = TSymbolUniqueId(3050);
    static constexpr const TSymbolUniqueId gl_PrimitiveIDTESES3_2       = TSymbolUniqueId(3051);
    static constexpr const TSymbolUniqueId gl_TessCoord                 = TSymbolUniqueId(3052);
    static constexpr const TSymbolUniqueId gl_TessLevelOuterTES         = TSymbolUniqueId(3053);
    static constexpr const TSymbolUniqueId gl_TessLevelOuterTESES3_2    = TSymbolUniqueId(3054);
    static constexpr const TSymbolUniqueId gl_TessLevelInnerTES         = TSymbolUniqueId(3055);
    static constexpr const TSymbolUniqueId gl_TessLevelInnerTESES3_2    = TSymbolUniqueId(3056);
    static constexpr const TSymbolUniqueId gl_PerVertexTES              = TSymbolUniqueId(3057);
    static constexpr const TSymbolUniqueId gl_PerVertexTESES3_2         = TSymbolUniqueId(3058);
    static constexpr const TSymbolUniqueId gl_inTES                     = TSymbolUniqueId(3059);
    static constexpr const TSymbolUniqueId gl_inTESES3_2                = TSymbolUniqueId(3060);
    static constexpr const TSymbolUniqueId gl_outTES                    = TSymbolUniqueId(3061);
    static constexpr const TSymbolUniqueId gl_outTESES3_2               = TSymbolUniqueId(3062);
    static constexpr const TSymbolUniqueId gl_PerVertexOutTesBlock      = TSymbolUniqueId(3063);
    static constexpr const TSymbolUniqueId gl_PerVertexOutTesBlockES3_2 = TSymbolUniqueId(3064);
    static constexpr const TSymbolUniqueId gl_PositionTES               = TSymbolUniqueId(3065);
    static constexpr const TSymbolUniqueId gl_PositionTESES3_2          = TSymbolUniqueId(3066);
    static constexpr const TSymbolUniqueId gl_ViewID_OVR                = TSymbolUniqueId(3067);
