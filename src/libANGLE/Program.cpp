...
template <typename T>
void Program::Data::updateUniformData(GLint location, GLsizei count, const T *v)
{
    const VariableLocation &locationInfo = mUniformLocations[location];
    LinkedUniform *linkedUniform         = &mUniforms[locationInfo.index];
    uint8_t *destPointer = linkedUniform->getDataPtrToElement(locationInfo.element);
    memcpy(destPointer, v, sizeof(T) * count);
}

template <size_t cols, size_t rows, typename T>
void Program::Data::updateMatrixUniformData(GLint location,
                                            GLsizei count,
                                            GLboolean transpose,
                                            const T *v)
{
    if (!transpose)
    {
        updateUniformData(location, count * cols * rows, v);
        return;
    }
...
{
    mData.updateUniformData(location, count * 1, v);
    mProgram->setUniform1fv(location, count, v);
}

void Program::setUniform2fv(GLint location, GLsizei count, const GLfloat *v)
{
    mData.updateUniformData(location, count * 2, v);
    mProgram->setUniform2fv(location, count, v);
}

void Program::setUniform3fv(GLint location, GLsizei count, const GLfloat *v)
{
    mData.updateUniformData(location, count * 3, v);
    mProgram->setUniform3fv(location, count, v);
}

void Program::setUniform4fv(GLint location, GLsizei count, const GLfloat *v)
{
    mData.updateUniformData(location, count * 4, v);
...
{
    mData.updateMatrixUniformData<2, 2>(location, count, transpose, v);
...
{
    mData.updateMatrixUniformData<3, 3>(location, count, transpose, v);
...
{
    mData.updateMatrixUniformData<4, 4>(location, count, transpose, v);
...
{
    mData.updateMatrixUniformData<2, 3>(location, count, transpose, v);
...
{
    mData.updateMatrixUniformData<2, 4>(location, count, transpose, v);
...
{
    mData.updateMatrixUniformData<3, 2>(location, count, transpose, v);
...
{
    mData.updateMatrixUniformData<3, 4>(location, count, transpose, v);
...
{
    mData.updateMatrixUniformData<4, 2>(location, count, transpose, v);
...
{
    mData.updateMatrixUniformData<4, 3>(location, count, transpose, v);
