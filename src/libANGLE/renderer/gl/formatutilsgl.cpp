                                      ...
                                      const gl::InternalFormat &internalFormat)
{
    ...
    else if (functions->isAtLeastGLES(gl::Version(3, 0)))
    {
        ...
        {
            // GL_BGRA_EXT was clarified as an internal format in GL_EXT_texture_format_BGRA8888,
            // but not all drivers support it.  Map it back to equivalent GL_BGRA8_EXT.
            result = GL_BGRA8_EXT;
        }
    }
