...
{
    using AccessPattern  = mtl::Buffer::AccessPattern;
    AccessPattern access = mSize <= kSharedMemBufferMaxBufSizeHint ? AccessPattern::SmallBuffer
                                                                   : AccessPattern::LargeBuffer;
    return Buffer::getStorageModeForAccessPattern(contextMtl, access);
}
