...
inline constexpr const char *kBaseLevelNonZeroForbidden = "Non-zero base level forbidden on mutable textures with incompatibly defined levels.";
...
inline constexpr const char *kIncompatibleLevelWithNonZeroBaseLevelForbidden = "Incompatible definition of mutable texture levels forbidden when base level is not zero.";
