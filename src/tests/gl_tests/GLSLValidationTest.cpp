...
TEST_P(GLSLValidationTest_ES3, TextureLodOffsetOutOfRange)
{
    ...
    validateError(GL_FRAGMENT_SHADER, kFS, "'8' : Texture offset value out of valid range");
}
...
TEST_P(GLSLValidationTest_ES31, WorkGroupSizeTooBigXDimension)
{
    ...
    validateError(
        GL_COMPUTE_SHADER, kCS,
        "'local_size_x' : invalid value: Value must be at least 1 and no greater than 256");
}
...
TEST_P(GLSLValidationTest_ES31, WorkGroupSizeTooBigYDimension)
{
    ...
    validateError(
        GL_COMPUTE_SHADER, kCS,
        "'local_size_y' : invalid value: Value must be at least 1 and no greater than 256");
}
...
TEST_P(GLSLValidationTest_ES31, WorkGroupSizeTooBigZDimension)
{
    ...
    validateError(
        GL_COMPUTE_SHADER, kCS,
        "'local_size_z' : invalid value: Value must be at least 1 and no greater than 64");
}
