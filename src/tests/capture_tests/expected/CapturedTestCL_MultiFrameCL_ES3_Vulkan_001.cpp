...
void ReplayFrame2(void)
{
    ...
    clEnqueueNDRangeKernel(clCommandQueuesMap[0], clKernelsMap[1], 1, NULL, (const size_t *)&gBinaryData[0], NULL, 0, NULL, NULL);
}
...
void ReplayFrame3(void)
{
    ...
    clSetKernelArg(clKernelsMap[1], 0, 8, (const void *)&clMemMap[0]);
    clEnqueueNDRangeKernel(clCommandQueuesMap[0], clKernelsMap[1], 1, NULL, (const size_t *)&gBinaryData[16], NULL, 0, NULL, NULL);
}
...
void ReplayFrame4(void)
{
    ...
    clSetKernelArg(clKernelsMap[1], 0, 8, (const void *)&clMemMap[0]);
    clEnqueueNDRangeKernel(clCommandQueuesMap[0], clKernelsMap[1], 1, NULL, (const size_t *)&gBinaryData[32], NULL, 0, NULL, NULL);
}
...
void ReplayFrame5(void)
{
    ...
    clSetKernelArg(clKernelsMap[1], 0, 8, (const void *)&clMemMap[0]);
    clEnqueueNDRangeKernel(clCommandQueuesMap[0], clKernelsMap[1], 1, NULL, (const size_t *)&gBinaryData[48], NULL, 0, NULL, NULL);
}
