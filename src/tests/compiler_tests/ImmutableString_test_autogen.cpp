...
TEST(ImmutableStringTest, ScriptGeneratedHashesMatch)
{
    ...
    ASSERT_EQ(0x0000060eu, ImmutableString("numSamples(").mangledNameHash());
    ASSERT_EQ(0x0000060fu, ImmutableString("samplePosition(00D").mangledNameHash());
    ASSERT_EQ(0x00000610u, ImmutableString("interpolateAtCenter(00B").mangledNameHash());
    ASSERT_EQ(0x00000611u, ImmutableString("interpolateAtCenter(10B").mangledNameHash());
    ASSERT_EQ(0x00000612u, ImmutableString("interpolateAtCenter(20B").mangledNameHash());
    ASSERT_EQ(0x00000613u, ImmutableString("interpolateAtCenter(30B").mangledNameHash());
    ASSERT_EQ(0x00000614u, ImmutableString("saturate(00B").mangledNameHash());
    ASSERT_EQ(0x00000615u, ImmutableString("saturate(10B").mangledNameHash());
    ASSERT_EQ(0x00000616u, ImmutableString("saturate(20B").mangledNameHash());
    ASSERT_EQ(0x00000617u, ImmutableString("saturate(30B").mangledNameHash());
    ASSERT_EQ(0x00000618u, ImmutableString("gl_DepthRangeParameters").mangledNameHash());
    ASSERT_EQ(0x00000619u, ImmutableString("gl_DepthRange").mangledNameHash());
    ASSERT_EQ(0x0000061au, ImmutableString("gl_NumSamples").mangledNameHash());
    ASSERT_EQ(0x0000061bu, ImmutableString("gl_MaxVertexAttribs").mangledNameHash());
    ASSERT_EQ(0x0000061cu, ImmutableString("gl_MaxVertexUniformVectors").mangledNameHash());
    ASSERT_EQ(0x0000061du, ImmutableString("gl_MaxVertexTextureImageUnits").mangledNameHash());
    ASSERT_EQ(0x0000061eu, ImmutableString("gl_MaxCombinedTextureImageUnits").mangledNameHash());
    ASSERT_EQ(0x0000061fu, ImmutableString("gl_MaxTextureImageUnits").mangledNameHash());
    ASSERT_EQ(0x00000620u, ImmutableString("gl_MaxFragmentUniformVectors").mangledNameHash());
    ASSERT_EQ(0x00000621u, ImmutableString("gl_MaxVaryingVectors").mangledNameHash());
    ASSERT_EQ(0x00000622u, ImmutableString("gl_MaxDrawBuffers").mangledNameHash());
    ASSERT_EQ(0x00000623u, ImmutableString("gl_MaxDualSourceDrawBuffersEXT").mangledNameHash());
    ASSERT_EQ(0x00000624u, ImmutableString("gl_MaxVertexOutputVectors").mangledNameHash());
    ASSERT_EQ(0x00000625u, ImmutableString("gl_MaxFragmentInputVectors").mangledNameHash());
    ASSERT_EQ(0x00000626u, ImmutableString("gl_MinProgramTexelOffset").mangledNameHash());
    ASSERT_EQ(0x00000627u, ImmutableString("gl_MaxProgramTexelOffset").mangledNameHash());
    ASSERT_EQ(0x00000628u, ImmutableString("gl_MaxImageUnits").mangledNameHash());
    ASSERT_EQ(0x00000629u, ImmutableString("gl_MaxVertexImageUniforms").mangledNameHash());
    ASSERT_EQ(0x0000062au, ImmutableString("gl_MaxFragmentImageUniforms").mangledNameHash());
    ASSERT_EQ(0x0000062bu, ImmutableString("gl_MaxComputeImageUniforms").mangledNameHash());
    ASSERT_EQ(0x0000062cu, ImmutableString("gl_MaxCombinedImageUniforms").mangledNameHash());
    ASSERT_EQ(0x0000062du,
              ImmutableString("gl_MaxCombinedShaderOutputResources").mangledNameHash());
    ASSERT_EQ(0x0000062eu, ImmutableString("gl_MaxComputeWorkGroupCount").mangledNameHash());
    ASSERT_EQ(0x0000062fu, ImmutableString("gl_MaxComputeWorkGroupSize").mangledNameHash());
    ASSERT_EQ(0x00000630u, ImmutableString("gl_MaxComputeUniformComponents").mangledNameHash());
    ASSERT_EQ(0x00000631u, ImmutableString("gl_MaxComputeTextureImageUnits").mangledNameHash());
    ASSERT_EQ(0x00000632u, ImmutableString("gl_MaxComputeAtomicCounters").mangledNameHash());
    ASSERT_EQ(0x00000633u, ImmutableString("gl_MaxComputeAtomicCounterBuffers").mangledNameHash());
    ASSERT_EQ(0x00000634u, ImmutableString("gl_MaxVertexAtomicCounters").mangledNameHash());
    ASSERT_EQ(0x00000635u, ImmutableString("gl_MaxFragmentAtomicCounters").mangledNameHash());
    ASSERT_EQ(0x00000636u, ImmutableString("gl_MaxCombinedAtomicCounters").mangledNameHash());
    ASSERT_EQ(0x00000637u, ImmutableString("gl_MaxAtomicCounterBindings").mangledNameHash());
    ASSERT_EQ(0x00000638u, ImmutableString("gl_MaxVertexAtomicCounterBuffers").mangledNameHash());
    ASSERT_EQ(0x00000639u, ImmutableString("gl_MaxFragmentAtomicCounterBuffers").mangledNameHash());
    ASSERT_EQ(0x0000063au, ImmutableString("gl_MaxCombinedAtomicCounterBuffers").mangledNameHash());
    ASSERT_EQ(0x0000063bu, ImmutableString("gl_MaxAtomicCounterBufferSize").mangledNameHash());
    ASSERT_EQ(0x0000063cu, ImmutableString("gl_MaxGeometryInputComponents").mangledNameHash());
    ASSERT_EQ(0x0000063du, ImmutableString("gl_MaxGeometryOutputComponents").mangledNameHash());
    ASSERT_EQ(0x0000063eu, ImmutableString("gl_MaxGeometryImageUniforms").mangledNameHash());
    ASSERT_EQ(0x0000063fu, ImmutableString("gl_MaxGeometryTextureImageUnits").mangledNameHash());
    ASSERT_EQ(0x00000640u, ImmutableString("gl_MaxGeometryOutputVertices").mangledNameHash());
    ASSERT_EQ(0x00000641u,
              ImmutableString("gl_MaxGeometryTotalOutputComponents").mangledNameHash());
    ASSERT_EQ(0x00000642u, ImmutableString("gl_MaxGeometryUniformComponents").mangledNameHash());
    ASSERT_EQ(0x00000643u, ImmutableString("gl_MaxGeometryAtomicCounters").mangledNameHash());
    ASSERT_EQ(0x00000644u, ImmutableString("gl_MaxGeometryAtomicCounterBuffers").mangledNameHash());
    ASSERT_EQ(0x00000645u, ImmutableString("gl_MaxTessControlInputComponents").mangledNameHash());
    ASSERT_EQ(0x00000646u, ImmutableString("gl_MaxTessControlOutputComponents").mangledNameHash());
    ASSERT_EQ(0x00000647u, ImmutableString("gl_MaxTessControlTextureImageUnits").mangledNameHash());
    ASSERT_EQ(0x00000648u, ImmutableString("gl_MaxTessControlUniformComponents").mangledNameHash());
    ASSERT_EQ(0x00000649u,
              ImmutableString("gl_MaxTessControlTotalOutputComponents").mangledNameHash());
    ASSERT_EQ(0x0000064au, ImmutableString("gl_MaxTessControlImageUniforms").mangledNameHash());
    ASSERT_EQ(0x0000064bu, ImmutableString("gl_MaxTessControlAtomicCounters").mangledNameHash());
    ASSERT_EQ(0x0000064cu,
              ImmutableString("gl_MaxTessControlAtomicCounterBuffers").mangledNameHash());
    ASSERT_EQ(0x0000064du, ImmutableString("gl_MaxTessPatchComponents").mangledNameHash());
    ASSERT_EQ(0x0000064eu, ImmutableString("gl_MaxPatchVertices").mangledNameHash());
    ASSERT_EQ(0x0000064fu, ImmutableString("gl_MaxTessGenLevel").mangledNameHash());
    ...
    ASSERT_EQ(0x00000654u, ImmutableString("gl_MaxTessEvaluationImageUniforms").mangledNameHash());
    ASSERT_EQ(0x00000655u, ImmutableString("gl_MaxTessEvaluationAtomicCounters").mangledNameHash());
    ASSERT_EQ(0x00000656u,
              ImmutableString("gl_MaxTessEvaluationAtomicCounterBuffers").mangledNameHash());
    ASSERT_EQ(0x00000657u, ImmutableString("gl_MaxSamples").mangledNameHash());
    ASSERT_EQ(0x00000658u, ImmutableString("gl_MaxClipDistances").mangledNameHash());
    ASSERT_EQ(0x00000659u, ImmutableString("gl_MaxCullDistances").mangledNameHash());
    ASSERT_EQ(0x0000065au, ImmutableString("gl_MaxCombinedClipAndCullDistances").mangledNameHash());
    ASSERT_EQ(0x0000065bu, ImmutableString("gl_FragCoord").mangledNameHash());
    ASSERT_EQ(0x0000065cu, ImmutableString("gl_FrontFacing").mangledNameHash());
    ASSERT_EQ(0x0000065du, ImmutableString("gl_PointCoord").mangledNameHash());
    ASSERT_EQ(0x0000065eu, ImmutableString("gl_FragColor").mangledNameHash());
    ASSERT_EQ(0x0000065fu, ImmutableString("gl_FragData").mangledNameHash());
    ASSERT_EQ(0x00000660u, ImmutableString("gl_FragDepth").mangledNameHash());
    ASSERT_EQ(0x00000661u, ImmutableString("gl_HelperInvocation").mangledNameHash());
    ASSERT_EQ(0x00000662u, ImmutableString("gl_SecondaryFragColorEXT").mangledNameHash());
    ASSERT_EQ(0x00000663u, ImmutableString("gl_SecondaryFragDataEXT").mangledNameHash());
    ASSERT_EQ(0x00000664u, ImmutableString("gl_FragDepthEXT").mangledNameHash());
    ASSERT_EQ(0x00000665u, ImmutableString("gl_LastFragData").mangledNameHash());
    ASSERT_EQ(0x00000666u, ImmutableString("gl_LastFragColor").mangledNameHash());
    ASSERT_EQ(0x00000667u, ImmutableString("gl_LastFragColorARM").mangledNameHash());
    ASSERT_EQ(0x00000668u, ImmutableString("gl_LastFragDepthARM").mangledNameHash());
    ASSERT_EQ(0x00000669u, ImmutableString("gl_LastFragStencilARM").mangledNameHash());
    ...
    ASSERT_EQ(0x0000066cu, ImmutableString("gl_SampleID").mangledNameHash());
    ASSERT_EQ(0x0000066du, ImmutableString("gl_SamplePosition").mangledNameHash());
    ASSERT_EQ(0x0000066eu, ImmutableString("gl_SampleMaskIn").mangledNameHash());
    ASSERT_EQ(0x0000066fu, ImmutableString("gl_SampleMask").mangledNameHash());
    ASSERT_EQ(0x00000670u, ImmutableString("gl_Position").mangledNameHash());
    ASSERT_EQ(0x00000671u, ImmutableString("gl_PointSize").mangledNameHash());
    ASSERT_EQ(0x00000672u, ImmutableString("gl_InstanceID").mangledNameHash());
    ASSERT_EQ(0x00000673u, ImmutableString("gl_InstanceIndex").mangledNameHash());
    ASSERT_EQ(0x00000674u, ImmutableString("gl_VertexID").mangledNameHash());
    ASSERT_EQ(0x00000675u, ImmutableString("gl_VertexIndex").mangledNameHash());
    ASSERT_EQ(0x00000676u, ImmutableString("gl_DrawID").mangledNameHash());
    ASSERT_EQ(0x00000677u, ImmutableString("gl_BaseVertex").mangledNameHash());
    ASSERT_EQ(0x00000678u, ImmutableString("gl_BaseInstance").mangledNameHash());
    ASSERT_EQ(0x00000679u, ImmutableString("angle_BaseVertex").mangledNameHash());
    ASSERT_EQ(0x0000067au, ImmutableString("angle_BaseInstance").mangledNameHash());
    ASSERT_EQ(0x0000067bu, ImmutableString("gl_ClipDistance").mangledNameHash());
    ASSERT_EQ(0x0000067cu, ImmutableString("gl_NumWorkGroups").mangledNameHash());
    ASSERT_EQ(0x0000067du, ImmutableString("gl_WorkGroupSize").mangledNameHash());
    ASSERT_EQ(0x0000067eu, ImmutableString("gl_WorkGroupID").mangledNameHash());
    ASSERT_EQ(0x0000067fu, ImmutableString("gl_LocalInvocationID").mangledNameHash());
    ASSERT_EQ(0x00000680u, ImmutableString("gl_GlobalInvocationID").mangledNameHash());
    ASSERT_EQ(0x00000681u, ImmutableString("gl_LocalInvocationIndex").mangledNameHash());
    ASSERT_EQ(0x00000682u, ImmutableString("gl_PrimitiveIDIn").mangledNameHash());
    ASSERT_EQ(0x00000683u, ImmutableString("gl_InvocationID").mangledNameHash());
    ASSERT_EQ(0x00000684u, ImmutableString("gl_PerVertex").mangledNameHash());
    ASSERT_EQ(0x00000685u, ImmutableString("gl_in").mangledNameHash());
    ASSERT_EQ(0x00000686u, ImmutableString("gl_PatchVerticesIn").mangledNameHash());
    ASSERT_EQ(0x00000687u, ImmutableString("gl_TessLevelOuter").mangledNameHash());
    ASSERT_EQ(0x00000688u, ImmutableString("gl_TessLevelInner").mangledNameHash());
    ASSERT_EQ(0x00000689u, ImmutableString("gl_out").mangledNameHash());
    ASSERT_EQ(0x0000068au, ImmutableString("gl_BoundingBox").mangledNameHash());
    ASSERT_EQ(0x0000068bu, ImmutableString("gl_BoundingBoxEXT").mangledNameHash());
    ASSERT_EQ(0x0000068cu, ImmutableString("gl_BoundingBoxOES").mangledNameHash());
    ASSERT_EQ(0x0000068du, ImmutableString("gl_TessCoord").mangledNameHash());
    ASSERT_EQ(0x0000068eu, ImmutableString("gl_ViewID_OVR").mangledNameHash());
    ASSERT_EQ(0x0000068fu, ImmutableString("gl_CullDistance").mangledNameHash());
