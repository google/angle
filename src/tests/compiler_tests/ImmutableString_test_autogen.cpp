...
TEST(ImmutableStringTest, ScriptGeneratedHashesMatch)
{
    ...
    ASSERT_EQ(0x0000057du, ImmutableString("gl_ClipDistance").mangledNameHash());
    ASSERT_EQ(0x0000057eu, ImmutableString("gl_PrimitiveShadingRateEXT").mangledNameHash());
    ASSERT_EQ(0x0000057fu, ImmutableString("gl_NumWorkGroups").mangledNameHash());
    ASSERT_EQ(0x00000580u, ImmutableString("gl_WorkGroupSize").mangledNameHash());
    ASSERT_EQ(0x00000581u, ImmutableString("gl_WorkGroupID").mangledNameHash());
    ASSERT_EQ(0x00000582u, ImmutableString("gl_LocalInvocationID").mangledNameHash());
    ASSERT_EQ(0x00000583u, ImmutableString("gl_GlobalInvocationID").mangledNameHash());
    ASSERT_EQ(0x00000584u, ImmutableString("gl_LocalInvocationIndex").mangledNameHash());
    ASSERT_EQ(0x00000585u, ImmutableString("gl_PrimitiveIDIn").mangledNameHash());
    ASSERT_EQ(0x00000586u, ImmutableString("gl_InvocationID").mangledNameHash());
    ASSERT_EQ(0x00000587u, ImmutableString("gl_PerVertex").mangledNameHash());
    ASSERT_EQ(0x00000588u, ImmutableString("gl_in").mangledNameHash());
    ASSERT_EQ(0x00000589u, ImmutableString("gl_PatchVerticesIn").mangledNameHash());
    ASSERT_EQ(0x0000058au, ImmutableString("gl_TessLevelOuter").mangledNameHash());
    ASSERT_EQ(0x0000058bu, ImmutableString("gl_TessLevelInner").mangledNameHash());
    ASSERT_EQ(0x0000058cu, ImmutableString("gl_out").mangledNameHash());
    ASSERT_EQ(0x0000058du, ImmutableString("gl_BoundingBox").mangledNameHash());
    ASSERT_EQ(0x0000058eu, ImmutableString("gl_BoundingBoxEXT").mangledNameHash());
    ASSERT_EQ(0x0000058fu, ImmutableString("gl_BoundingBoxOES").mangledNameHash());
    ASSERT_EQ(0x00000590u, ImmutableString("gl_TessCoord").mangledNameHash());
    ASSERT_EQ(0x00000591u, ImmutableString("gl_ViewID_OVR").mangledNameHash());
    ASSERT_EQ(0x00000592u, ImmutableString("gl_CullDistance").mangledNameHash());
